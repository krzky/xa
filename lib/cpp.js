...
//     demo: { isEnabled: true, text: ['.cpp printf("Hello from XA!");', '.cpp float x, y;\ncin >> x >> y;\ncout<<"sum of provide numbers is -> " << x + y; -i 6 0.9', '.cpp #include <bits/stdc++.h>\nusing namespace std;\n\nint main() {\n  cout << "XA is the best!" << endl;\n}'] },
...
//                 cpp = code;
//             }
//             fs.writeFileSync('./tmp/cpp-XA.cpp', cpp);
//             var out = {
//                 stderr: 'N/A',
//                 stdout: 'N/A',
//                 code: cpp
//             }
//             var compile = "g++ ./tmp/cpp-XA.cpp -o ./tmp/cppXA.out"
//             var execute = "env -i ./tmp/cppXA.out"
//             try {
//                 await exec(compile)
//                 var child = execFile("env -i ./tmp/cppXA.out", [], {shell: true},
